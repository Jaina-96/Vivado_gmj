...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set afe_clk_d [ create_bd_port -dir O afe_clk_d ]
  set afe_shaping [ create_bd_port -dir O afe_shaping ]
  set clk_1mhz [ create_bd_port -dir O clk_1mhz ]
  set cp1 [ create_bd_port -dir I cp1 ]
  set cp2 [ create_bd_port -dir I cp2 ]
  set dbe_reset [ create_bd_port -dir O dbe_reset ]
  set decision [ create_bd_port -dir I decision ]
  ...
  set hclk [ create_bd_port -dir O hclk ]
  set lsb [ create_bd_port -dir I lsb ]
  set muxout0 [ create_bd_port -dir I muxout0 ]
  set muxout1 [ create_bd_port -dir I muxout1 ]
  set muxout2 [ create_bd_port -dir I muxout2 ]
  set muxout3 [ create_bd_port -dir I muxout3 ]
  set muxout4 [ create_bd_port -dir I muxout4 ]
  set nclk [ create_bd_port -dir O nclk ]
  set node_sel [ create_bd_port -dir O node_sel ]
  ...
  set s2b [ create_bd_port -dir O s2b ]
  set s3 [ create_bd_port -dir O s3 ]
  set s4 [ create_bd_port -dir O s4 ]
  set s5 [ create_bd_port -dir O s5 ]
  set s6 [ create_bd_port -dir O s6 ]
  set s7 [ create_bd_port -dir O s7 ]
  set start_sending_0 [ create_bd_port -dir O start_sending_0 ]
  set state1 [ create_bd_port -dir O state1 ]
  set state2 [ create_bd_port -dir O state2 ]
  set state3 [ create_bd_port -dir O state3 ]
  set state4 [ create_bd_port -dir O state4 ]
  set state5 [ create_bd_port -dir O state5 ]
  set state6 [ create_bd_port -dir O state6 ]
  set stim_SerialIn [ create_bd_port -dir O stim_SerialIn ]
  set stim_dac_load [ create_bd_port -dir O stim_dac_load ]
  set stim_serialshift [ create_bd_port -dir O stim_serialshift ]
  set sys_clock [ create_bd_port -dir I -type clk sys_clock ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000} \
   CONFIG.PHASE {0.000} \
 ] $sys_clock
  set tx_txdata [ create_bd_port -dir O tx_txdata ]
  set vadj [ create_bd_port -dir O -from 2 -to 0 vadj ]
  set voladj [ create_bd_port -dir I -from 2 -to 0 voladj ]

  # Create instance: GMJ_ctrl_top_0, and set properties
  set GMJ_ctrl_top_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:GMJ_ctrl_top:1.0 GMJ_ctrl_top_0 ]
 ...
 ] [get_bd_intf_pins /GMJ_ctrl_top_0/s00_axi]

  # Create instance: UDP_1, and set properties
  set UDP_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:UDP:3 UDP_1 ]
  ...
  # Create instance: flash_adc_0, and set properties
  set flash_adc_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:flash_adc:1.0 flash_adc_0 ]

  # Create instance: fsm_saradc_0, and set properties
  set fsm_saradc_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:fsm_saradc:1.0 fsm_saradc_0 ]
  set_property -dict [ list \
   CONFIG.N {4} \
 ] $fsm_saradc_0
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins GMJ_ctrl_top_0/s00_axi] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  # Create port connections
  connect_bd_net -net GMJ_ctrl_top_0_afe_shaping [get_bd_ports afe_shaping] [get_bd_pins GMJ_ctrl_top_0/afe_shaping]
  connect_bd_net -net GMJ_ctrl_top_0_node_sel [get_bd_ports node_sel] [get_bd_pins GMJ_ctrl_top_0/node_sel]
  connect_bd_net -net GMJ_ctrl_top_0_reset_signal [get_bd_pins GMJ_ctrl_top_0/reset_signal] [get_bd_pins flash_adc_0/reset] [get_bd_pins fsm_saradc_0/reset]
  connect_bd_net -net Net [get_bd_ports eth_mdio] [get_bd_pins UDP_1/eth_mdio]
  connect_bd_net -net Net1 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins clk_0/clk_in_500MHz] [get_bd_pins clk_wiz_1/clk_out1]
  connect_bd_net -net UDP_1_addr [get_bd_pins UDP_1/addr] [get_bd_pins dist_mem_gen_0/a]
  ...
  connect_bd_net -net UDP_1_write_en [get_bd_pins UDP_1/write_en] [get_bd_pins dist_mem_gen_0/we]
  ...
  connect_bd_net -net clk_0_STIM [get_bd_ports stim_dac_load] [get_bd_pins clk_0/STIM]
  ...
  connect_bd_net -net clk_0_clk_d [get_bd_ports stim_serialshift] [get_bd_pins clk_0/clk_d]
  connect_bd_net -net clk_0_clk_dac [get_bd_ports stim_SerialIn] [get_bd_pins clk_0/clk_dac]
  connect_bd_net -net clk_0_clk_dac_d [get_bd_ports dbe_reset] [get_bd_pins clk_0/clk_dac_d]
  connect_bd_net -net clk_0_clk_dac_p [get_bd_ports tx_txdata] [get_bd_pins clk_0/clk_dac_p]
  connect_bd_net -net clk_0_clk_out_UDP [get_bd_ports hclk] [get_bd_pins clk_0/clk_out_UDP]
  connect_bd_net -net clk_0_clk_p [get_bd_ports clk_1mhz] [get_bd_pins clk_0/clk_p] [get_bd_pins flash_adc_0/clk_1mhz] [get_bd_pins fsm_saradc_0/clk_1Mhz]
  connect_bd_net -net clk_0_clk_short [get_bd_ports nclk] [get_bd_pins clk_0/clk_short]
  ...
  connect_bd_net -net cp1_1 [get_bd_ports cp1] [get_bd_pins GMJ_ctrl_top_0/afe_node_cp1]
  connect_bd_net -net cp2_1 [get_bd_ports cp2] [get_bd_pins GMJ_ctrl_top_0/afe_node_cp2]
  connect_bd_net -net decision_1 [get_bd_ports decision] [get_bd_pins fsm_saradc_0/decision]
  ...
  connect_bd_net -net fsm_saradc_0_S1 [get_bd_ports s1] [get_bd_pins fsm_saradc_0/S1]
  connect_bd_net -net fsm_saradc_0_S2 [get_bd_ports s2] [get_bd_pins fsm_saradc_0/S2]
  connect_bd_net -net fsm_saradc_0_S2B [get_bd_ports s2b] [get_bd_pins fsm_saradc_0/S2B]
  connect_bd_net -net fsm_saradc_0_S3 [get_bd_ports s3] [get_bd_pins fsm_saradc_0/S3]
  connect_bd_net -net fsm_saradc_0_S4 [get_bd_ports s4] [get_bd_pins fsm_saradc_0/S4]
  connect_bd_net -net fsm_saradc_0_S5 [get_bd_ports s5] [get_bd_pins fsm_saradc_0/S5]
  connect_bd_net -net fsm_saradc_0_S6 [get_bd_ports s6] [get_bd_pins fsm_saradc_0/S6]
  connect_bd_net -net fsm_saradc_0_S7 [get_bd_ports s7] [get_bd_pins fsm_saradc_0/S7]
  connect_bd_net -net fsm_saradc_0_comp_clk [get_bd_ports afe_clk_d] [get_bd_pins fsm_saradc_0/comp_clk]
  connect_bd_net -net fsm_saradc_0_flag [get_bd_pins dist_mem_gen_0/d] [get_bd_pins flash_adc_0/flag] [get_bd_pins fsm_saradc_0/flag]
  connect_bd_net -net fsm_saradc_0_state1 [get_bd_ports state1] [get_bd_pins fsm_saradc_0/state1]
  connect_bd_net -net fsm_saradc_0_state2 [get_bd_ports state2] [get_bd_pins fsm_saradc_0/state2]
  connect_bd_net -net fsm_saradc_0_state3 [get_bd_ports state3] [get_bd_pins fsm_saradc_0/state3]
  connect_bd_net -net fsm_saradc_0_state4 [get_bd_ports state4] [get_bd_pins fsm_saradc_0/state4]
  connect_bd_net -net fsm_saradc_0_state5 [get_bd_ports state5] [get_bd_pins fsm_saradc_0/state5]
  connect_bd_net -net fsm_saradc_0_state6 [get_bd_ports state6] [get_bd_pins fsm_saradc_0/state6]
  connect_bd_net -net lsb_1 [get_bd_ports lsb] [get_bd_pins flash_adc_0/lsb]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins GMJ_ctrl_top_0/s00_axi_aclk] [get_bd_pins UDP_1/clk100MHz] [get_bd_pins UDP_1/s00_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_0/s00_axi_aclk] [get_bd_pins clk_wiz_1/clk_out4] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net muxout0_1 [get_bd_ports muxout0] [get_bd_pins flash_adc_0/muxout0]
  connect_bd_net -net muxout1_1 [get_bd_ports muxout1] [get_bd_pins flash_adc_0/muxout1]
  connect_bd_net -net muxout2_1 [get_bd_ports muxout2] [get_bd_pins flash_adc_0/muxout2]
  connect_bd_net -net muxout3_1 [get_bd_ports muxout3] [get_bd_pins flash_adc_0/muxout3]
  connect_bd_net -net muxout4_1 [get_bd_ports muxout4] [get_bd_pins flash_adc_0/muxout4]
  ...
  connect_bd_net -net reswww_1 [get_bd_ports reswww] [get_bd_pins clk_0/reset]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_interconnect_aresetn [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_1_100M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins GMJ_ctrl_top_0/s00_axi_aresetn] [get_bd_pins UDP_1/s00_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins clk_0/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs GMJ_ctrl_top_0/s00_axi/reg0] SEG_GMJ_ctrl_top_0_reg0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs clk_0/S00_AXI/S00_AXI_reg] SEG_clk_0_S00_AXI_reg
