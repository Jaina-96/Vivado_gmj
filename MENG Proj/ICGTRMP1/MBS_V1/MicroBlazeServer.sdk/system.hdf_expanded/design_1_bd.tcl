...
proc create_root_design { parentCell } {
  ...
  set STIM [ create_bd_port -dir O STIM ]
  ...
  connect_bd_net -net clk_0_sample_c [get_bd_ports STIM] [get_bd_pins clk_0/STIM]
  connect_bd_net -net clk_0_sample_tr [get_bd_ports RST] [get_bd_pins clk_0/RST]
  ...
  connect_bd_net -net clk_wiz_1_clk_out4 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins clk_0/clk_in_500MHz] [get_bd_pins clk_wiz_1/clk_out1]
  ...
  connect_bd_net -net clock_gen_0_clk_out_10MHz [get_bd_pins UDP_1/clk_1MHz] [get_bd_pins clk_0/clk_out_UDP]
  connect_bd_net -net d_1 [get_bd_ports d] [get_bd_pins dist_mem_gen_0/d]
